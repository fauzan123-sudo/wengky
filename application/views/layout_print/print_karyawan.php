		...
		<table class="table table-striped mt-4" cellspacing ="0">
			<thead class="bg-blue-1 text-white ">
				<tr>
					<th>No</th>
					<th class="1">Nama</th>
					<th class="2">Tempat Lahir</th>
					<th class="3">Tanggal Lahir</th>
					<th class="4">Alamat</th>
					<th class="5">Email</th>
					<th class="6">Telepon	</th>
					<th class="7">Jabatan</th>
					<th class="8">NIP</th>
					<th class="9">Username</th>
					
				</tr>
			</thead>
			<tbody>
				<?php
				$karyawan = $this->m_data->read_data('pegawai')->result();
				 $no=1; foreach ($karyawan as $key) { 
				 	?>

					<tr>
						<td><?= $no ?></td>
						<td class="1"><?= $key->nama ?></td>
						<td class="2"><?= $key->tempat_lahir ?></td>
						<td class="3"><?= $key->tgl_lahir ?></td>
						<td class="4"><?= $key->alamat ?></td>
						<td class="5"><?= $key->email ?></td>
						<td class="6"><?= $key->no_tlp ?></td>
						<td class="7"><?= $key->jabatan ?></td>
						<td class="8"><?= $key->nip ?></td>
						<td class="9"><?= $key->username ?></td>
